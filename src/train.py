...
cross_validate_model(logistic_pipeline,X_train,y_train,cv)
cross_validate_model(knn_pipeline,X_train,y_train,cv)
cross_validate_model(decision_tree_model,X_train,y_train,cv)